  ...
  function updateCurrencyLogo() {
    const currencyOption = document.getElementById("pay-currency-option");
  ...
  document.getElementById("pay-currency-option").addEventListener("change", updateCurrencyLogo);
