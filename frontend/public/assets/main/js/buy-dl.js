  ...
  function updateCurrencyLogo() {
    const currencyOption = document.getElementById("buy-currency-option");
  ...
  document.getElementById("buy-currency-option").addEventListener("change", updateCurrencyLogo);
