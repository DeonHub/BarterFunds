          ...
          <PageContainer bodyClass="page-container">
            <article className="entry">
              ...
              <div style={{ marginBottom: '40px' }}>
                ...
                <a href={`${process.env.REACT_APP_PUBLIC_URL}/knowledge-base`} target="_blank" rel="noopener noreferrer">
              ...
              <div style={{ marginBottom: '40px' }}>
                ...
                <a href={`${process.env.REACT_APP_PUBLIC_URL}/faq`} target="_blank" rel="noopener noreferrer">
