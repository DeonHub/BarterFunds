...
const Business = ({ ...props }) => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>Business Solutions | BarterFunds</title>
        <meta name="description" content="BarterFunds offers secure and efficient financial solutions for businesses in Africa, enabling seamless transactions, multi-currency support, and cross-border operations." />
        <meta name="keywords" content="business finance, Africa, multi-currency support, cross-border transactions, business solutions" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="BarterFunds" />
        <meta property="og:title" content="Business Solutions | BarterFunds" />
        <meta property="og:description" content="Empower your business with BarterFunds' comprehensive financial solutions, tailored for African enterprises." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.barter-funds.com/business" />
        <meta property="og:image" content="https://www.barter-funds.com/images/business-solutions.jpg" />
      </Helmet>
      <Header />
