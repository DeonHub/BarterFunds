            ...
            <div className="bodywrapper__inner">
                ...
                <div className="d-flex mb-30 flex-wrap gap-3 justify-content-between align-items-center">
                    ...
                    <div className="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
                        <a href={`${process.env.PUBLIC_URL}/admin/tickets`} className="btn btn-sm btn-outline--primary">
                    ...
                    <div className="col-lg-12">
                        ...
                        <div className="card">
                            <div className="card-body ">
                                ...
                                <h6 className="card-title  mb-4">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-4  col-md-6 text-sm-end mt-sm-0 mt-3">
                                            <button className="btn btn--danger btn-sm" type="button" data-bs-toggle="modal"
                                                data-bs-target="#DelModal">
                                                <i className="fa fa-lg fa-times-circle"></i> Close Ticket </button>
                                        </div>
                                    </div>
                                </h6>
                                ...
                                <form action="../../admin/ticket/reply/10" enctype="multipart/form-data" method="post"
                                    className="form-horizontal">
                                    <input type="hidden" name="_token" value="E6VfIKYhkOrK7AbIz100xrYSi12cX4lyZLsKfwsE" />
                                    ...
                                    <div className="row ">
                                        ...
                                        <div className="col-md-6">
                                            <div className="row form-group">
                                                <div className="col-12">
                                                    <label for="inputAttachments">Attachments</label> <span
                                                        className="text--danger">Max 5 files can be uploaded. Maximum upload
                                                        size is 256M</span>
                                                </div>
                                                <div className="col-9">
                                                ...
                                                <div className="col-3">
                                                    <button type="button"
                                                        className="btn btn--dark extraTicketAttachment ms-0"><i
                                        ...
                                        <div className="col-md-3 offset-md-3">
                                            <button className="btn btn--primary w-100 mt-4" type="submit"
                                                name="replayTicket" value="1"><i className="la la-fw la-lg la-reply"></i>
                                                Reply </button>
                                        </div>
                                    </div>
                                ...
                                <div className="row border border--primary border-radius-3 my-3 mx-2">
                                    ...
                                    <div className="col-md-3 border-end text-md-end text-start">
                                        ...
                                        <p>@<span>Jamalia Crawford</span></p>
                                        <button className="btn btn-danger btn-sm my-3 confirmationBtn"
                                            data-question="Are you sure to delete this message?"
                                            data-action="../../admin/ticket/delete/15"><i className="la la-trash"></i>
                                            Delete</button>
                                    </div>

                                    <div className="col-md-9">
                                        <p className="text-muted fw-bold my-3">
                                            Posted on Sunday, 28th January 2024 @ 11:38</p>
                ...
                <div className="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    aria-hidden="true">
                ...
                <div id="confirmationModal" className="modal fade" tabindex="-1" role="dialog">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Confirmation Alert!</h5>
                                <span type="button" className="close" data-bs-dismiss="modal" aria-label="Close">
                                    <i className="las la-times"></i>
                                </span>
                            </div>
