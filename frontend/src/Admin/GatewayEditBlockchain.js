...
class GatewayEditBlockchain extends React.Component {
  constructor(props) {
    super(props);
    ...
    <div className="bodywrapper__inner">
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <form
              action="admin/gateway/automatic/update/501"
              method="POST"
            ...
            >
              ...
              />
              <input type="hidden" name="alias" defaultValue="Blockchain" />
              ...
              <div className="card-body">
                <div className="payment-method-item block-item">
                  ...
                  <div className="payment-method-body mt-2">
                    <h4 className="mb-3">Global Setting for Blockchain</h4>
                    <div className="row">
                      <div className="form-group col-lg-6">
                        ...
                        <input
                          ...
                          name="global[api_key]"
                          defaultValue="55529946-05ca-48ff-8710-f279d86b1cc5"
                          required=""
                        />
                      </div>
                      <div className="form-group col-lg-6">
                        ...
                        <input
                          type="text"
                          className="form-control"
                          name="global[xpub_code]"
                          defaultValue="xpub6CKQ3xxWyBoFAF83izZCSFUorptEU9AF8TezhtWeMU5oefjX3sFSBw62Lr9iHXPkXmDQJJiHZeTRtD9Vzt8grAYRhvbz4nEvBu3QKELVzFK"
                          required=""
                        />
                      </div>
                    </div>
                    ...
                    <div className="content w-100 ps-0">
                      <div className="d-flex justify-content-between">
                        <div className="form-group">
                          <h4 className="mb-3">Blockchain - BTC</h4>
                          <input
                            type="text"
                            className="form-control"
                            name="currency[1][name]"
                            defaultValue="Blockchain - BTC"
                            required=""
                          />
                        </div>
                        <div className="remove-btn">
                          <button
                            ...
                            data-action="admin/gateway/automatic/remove/69"
                          >
...
export default GatewayEditBlockchain;
