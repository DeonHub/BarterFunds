...
class GatewayEditPaypalsdk extends React.Component {
  constructor(props) {
    super(props);
    ...
    <div className="bodywrapper__inner">
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <form
              action="admin/gateway/automatic/update/113"
              method="POST"
            ...
            >
              ...
              />
              <input type="hidden" name="alias" defaultValue="PaypalSdk" />
              ...
              <div className="card-body">
                <div className="payment-method-item block-item">
                  ...
                  <div className="payment-method-body mt-2">
                    <h4 className="mb-3">Global Setting for Paypal Express</h4>
                    <div className="row">
                      <div className="form-group col-lg-6">
                        ...
                        <input
                          ...
                          defaultValue="Ae0-tixtSV7DvLwIh3Bmu7JvHrjh5EfGdXr_cEklKAVjjezRZ747BxKILiBdzlKKyp-W8W_T7CKH1Ken"
                          required=""
                        />
                      </div>
                      <div className="form-group col-lg-6">
                        ...
                        <input
                          type="text"
                          className="form-control"
                          name="global[clientSecret]"
                          defaultValue="EOhbvHZgFNO21soQJT1L9Q00M3rK6PIEsdiTgXRBt2gtGtxwRer5JvKnVUGNU5oE63fFnjnYY7hq3HBA"
                          required=""
                        />
                      </div>
                    </div>
                    ...
                    <div className="content w-100 ps-0">
                      <div className="d-flex justify-content-between">
                        <div className="form-group">
                          <h4 className="mb-3">Paypal Express - AUD</h4>
                          <input
                            type="text"
                            className="form-control"
                            name="currency[1][name]"
                            defaultValue="Paypal Express - AUD"
                            required=""
                          />
                        </div>
                        <div className="remove-btn">
                          <button
                            ...
                            data-action="admin/gateway/automatic/remove/55"
                          >
...
export default GatewayEditPaypalsdk;
