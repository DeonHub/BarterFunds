  ...
  <div className="body-wrapper">
    <div className="bodywrapper__inner">
      <div className="d-flex mb-30 flex-wrap gap-3 justify-content-between align-items-center">
        <h6 className="page-title">Active Users</h6>
              ...
              <div className="table-responsive--md  table-responsive">
                <table className="table table--light style--two">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <span className="fw-bold">kjbbvdkjb mn VMM</span>
                        <br />
                        <span className="small">
                          <a href="../../admin/users/detail/2340">
                            <span>@</span>104137182104610327437
                          </a>
                        </span>
                      </td>
                      <td>
                      ...
                      <td>
                        2023-07-17 04:55 PM <br />1 week ago
                      </td>
                      <td>
                        <span className="fw-bold">₵0.00</span>
                      </td>
              ...
              <nav>
                <ul className="pagination">
                  ...
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=2"
                    >
                      2
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=3"
                    >
                      3
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=4"
                    >
                      4
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=5"
                    >
                      5
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=6"
                    >
                      6
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=7"
                    >
                      7
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=8"
                    >
                      8
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=9"
                    >
                      9
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=10"
                    >
                      10
                    </a>
                  </li>
                  ...
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=68"
                    >
                      68
                    </a>
                  </li>
                  <li className="page-item">
                    <a
                      className="page-link"
                      href="../../admin/users/active?page=69"
                    >
                      69
                    </a>
                  </li>
