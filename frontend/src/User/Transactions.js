                    ...
                    <li>
                      <div className="dropdown">
                        <a
                          ...
                          data-bs-toggle="dropdown"
                        >
                          <div className="badge badge-circle bg-primary">4</div>
                        ...
                        <div className="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                          ...
                          <div className="dropdown-foot between">
                            ...
                            <a href="#savedFilter" data-bs-toggle="modal">
                              Save Filter
                            </a>
                          </div>
                        </div>
              ...
              <div className="nk-tb-list nk-tb-tnx">
                ...
                <div className="nk-tb-item">
                  ...
                  <div className="nk-tb-col tb-col-lg">
                    ...
                    <span className="badge badge-dot bg-success">Deposit</span>
                  </div>
                  <div className="nk-tb-col text-end">
                    <span className="tb-amount">
                      + 0.010201 <span>BTC</span>
                    </span>
                    <span className="tb-amount-sm">1290.49 USD</span>
                  </div>
                  <div className="nk-tb-col text-end tb-col-sm">
                    <span className="tb-amount">
                      1.30910201 <span>BTC</span>
                    </span>
                        ...
                        <div className="dropdown">
                          ...
                          <div className="dropdown-menu dropdown-menu-end">
                            <ul className="link-list-opt">
                              ...
                              <li>
                                <a href="#">
                                  <em className="icon ni ni-cross-round" />
                                  <span>Reject</span>
                                </a>
                              </li>
                              <li>
                ...
                <div className="nk-tb-item">
                  ...
                  <div className="nk-tb-col tb-col-lg">
                    <span className="tb-lead-sub">YWLX52JG73</span>
                    <span className="badge badge-dot bg-info">Profit</span>
                  </div>
                  <div className="nk-tb-col text-end">
                    <span className="tb-amount">
                      + 0.010201 <span>BTC</span>
                ...
                <div className="nk-tb-item">
                  ...
                  <div className="nk-tb-col tb-col-lg">
                    <span className="tb-lead-sub">YWLX52JG73</span>
                    <span className="badge badge-dot bg-warning">Deposit</span>
                  </div>
                  <div className="nk-tb-col text-end">
                    <span className="tb-amount">
                      + 0.010201 <span>BTC</span>
                  ...
                  <div className="nk-tb-col nk-tb-col-status">
                    <div className="dot dot-warning d-md-none" />
                    <span className="badge badge-sm badge-dim bg-outline-warning d-none d-md-inline-flex">
                      Pending
                    </span>
                  </div>
