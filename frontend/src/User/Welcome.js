                        ...
                        <div class="nk-sidebar-content">
                            <div class="nk-sidebar-menu">
                                <ul class="nk-menu">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="/panel/buy/btc.html" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni ni-panel"></em></span>
                                            <span class="nk-menu-text">Buy Sell Panel</span><span
                                                class="nk-menu-badge">HOT</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-heading">
                                        <h6 class="overline-title text-primary-alt">PAYMENTS</h6>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/wallet.html" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span>
                                            <span class="nk-menu-text">Barter Wallet</span><span
                                                class="nk-menu-badge">COMING SOON</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/transactions.html" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni ni-sign-cc-alt"></em></span>
                                            <span class="nk-menu-text">Manage Orders</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/coming-soon.html" class="nk-menu-link">
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item">
                                                <a href="/user/profile.html" class="nk-menu-link"><span
                                                        class="nk-menu-text">My
                                                        Profile</span></a>
                                            </li>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item">
                                                <a href="/order-history.html" class="nk-menu-link"><span
                                                        class="nk-menu-text">Transaction
                                                        History</span></a>
                                            </li>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item">
                                                <a href="/kyc/application.html" class="nk-menu-link"><span
                                                        class="nk-menu-text">Get
                                                        Started</span></a>
                                            </li>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item">
                                                <a href="/support.html" class="nk-menu-link"><span
                                                        class="nk-menu-text">Live
                                                        Chat</span></a>
                                            </li>
                                            <li class="nk-menu-item">
                                                <a href="/faqs.html" class="nk-menu-link"><span
                                                        class="nk-menu-text">Faqs
                                                        / Help</span></a>
                                            </li>
                                            <li class="nk-menu-item">
                                                <a href="https://wa.me/message/ON5PHWAZTGKWI1"
                                                    class="nk-menu-link"><span class="nk-menu-text">Whatsapp
                                                        Chat</span></a>
                                            </li>
                                            <li class="nk-menu-item">
                                                <a href="tel:+233598870911" class="nk-menu-link"><span
                                                        class="nk-menu-text">Phone
                                                        Call</span></a>
                                            </li>
                                ...
                                <div class="nk-news-list">
                                    <a class="nk-news-item" href="#">
                                        ...
                                        <div class="nk-news-text">
                                            <p>Get realtime update on our exchange rates<span> Subscribe to our
                                                    newsletter now!</span></p>
                                        ...
                                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    ...
                                                    <div class="user-name dropdown-indicator">Michael Adzato</div>
                                                </div>
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        <span class="lead-text">Michael Adzato</span>
                                                        <span class="sub-text">info@barter-funds.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="/frontend/admin/profile.html"><em
                                                                class="icon ni ni-user-alt"></em><span>View
                                                                Profile</span></a></li>
                                                    <li><a href="/frontend/admin/profile-security.html"><em
                                                                class="icon ni ni-setting-alt"></em><span>Account
                                                                Setting</span></a></li>
                                                    <li><a href="/frontend/admin/profile-activity.html"><em
                        ...
                        <div class="nk-content-body">
                            <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                                <div class="nk-block-head-content text-center">
                                    <h2 class="nk-block-title fw-normal">Nice, Michael Adzato!</h2>
                                    <div class="nk-block-des">
                                        <p>Welcome to <strong>Barter Funds</strong>. You are
                                            few steps
                                            away to complete your profile. These are required to buy and sell on our
                                            platform! Let’s start!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="nk-block">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card-inner-group h-100">
                                                <div class="card-inner">
                                                    ...
                                                    <p>Only few minutes required to complete your registration and set
                                                        up your account.</p>
                                                </div>
                                                <div class="card-inner">
                                                ...
                                                <div class="card-inner">
                                                    <div class="align-center gx-3">
                                                        ...
                                                        <div class="flex-item">
                                                            <span class="sub-text sub-text-sm text-soft">1/4
                                                                Completed</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="align-center flex-wrap flex-md-nowrap g-3 h-100">
                                                    <div
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114 113.9">
                                                            ...
                                                            <rect x="22" y="17.9" width="66" height="88" rx="3" ry="3"
                                                                fill="#6576ff" />
                                                            <rect x="31" y="85.9" width="48" height="10" rx="1.5"
                                                                ry="1.5" fill="#fff" />
                                                    ...
                                                    <div class="nk-block-content">
                                                        <div class="nk-block-content-head">
                                                            ...
                                                            <span class="sub-text sub-text-sm text-soft">7
                                                                minutes</span>
                                                        </div>
                                                        ...
                                                        <ul class="list list-sm list-checked">
                                                            <li>Fiat Currency Wallet <span>(GHS)</span></li>
                                                            <li>10+ Digital Currencies <span>(ETH, BTC, LTC
                                                                    etc)</span></li>
                                                            <li>Receive and send payment with Barter Funds</li>
                                                        </ul>
                                                        <a href="/frontend/admin//index.html"
                                            ...
                                            <div class="nk-block-content">
                                                <div class="nk-block-content-head px-lg-4">
                                                    ...
                                                    <p class="text-soft">Ask a question or file a support ticket, manage
                                                        request, report an issues. Our team support team will get back
                                                        to you by email.</p>
                                                </div>
                                            </div>
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2024 Barter Funds. All Rights Reserved. Powered by:
                                <a href="#" target="_blank"> Currency Technologies</a>
                            </div>
