    ...
    <div className="nk-content-body">
      <div className="nk-block-head nk-block-head-lg wide-xs mx-auto">
        <div className="nk-block-head-content text-center">
          <h2 className="nk-block-title fw-normal">Nice, Michael Adzato!</h2>
          <div className="nk-block-des">
            <p>
              Welcome to <strong>Barter Funds</strong>. You are few steps away
              to complete your profile. These are required to buy and sell on
              our platform! Let’s start!
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="col-lg-4">
              <div className="card-inner-group h-100">
                <div className="card-inner">
                  ...
                  <p>
                    Only few minutes required to complete your registration and
                    set up your account.
                  </p>
                </div>
                <div className="card-inner">
                ...
                <div className="align-center flex-wrap flex-md-nowrap g-3 h-100">
                  ...
                  <div className="nk-block-content">
                    ...
                    <ul className="list list-sm list-checked">
                      <li>
                        Fiat Currency Wallet <span>(GHS)</span>
                      </li>
                      <li>
                        10+ Digital Currencies <span>(ETH, BTC, LTC etc)</span>
                      </li>
                      <li>Receive and send payment with Barter Funds</li>
                    </ul>
                    <a
                      href="/frontend/admin//index.html"
