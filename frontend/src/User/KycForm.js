          ...
          <div className="card card-bordered">
            <div className="nk-kycfm">
              ...
              <div className="nk-kycfm-head">
                ...
                <div className="nk-kycfm-title">
                  <h5 className="title">Indentification</h5>
                  <p className="sub-title">
                    Your simple personal information required for identification
                  </p>
                </div>
                ...
                <div className="row g-4">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <div className="form-control-group">
                        <select className="form-control form-control-lg nationality-selector">
                ...
                <div className="row g-4">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <div className="form-label-group">
                        <label className="form-label">
                          GPS Address <span className="text-danger">*</span>
                        </label>
                      </div>
                      <div className="form-control-group">
                        <input
              ...
              <div className="nk-kycfm-content">
                ...
                <div className="nk-kycfm-upload">
                  <h6 className="title nk-kycfm-upload-title">ID Front</h6>
                  <div className="row align-items-center">
                    ...
                    <div className="col-sm-4 d-none d-sm-block">
                      <div className="mx-md-4">
                        <img
                          src="/frontend/user/images/icons/id-front.svg"
                          alt="ID Front"
                        />
                      </div>
                    </div>
                ...
                {/* nk-kycfm-upload */}
                <div className="nk-kycfm-upload">
                  <h6 className="title nk-kycfm-upload-title">ID Back</h6>
                  <div className="row align-items-center">
                    <div className="col-sm-8">
                      <div className="nk-kycfm-upload-box">
                        <div className="upload-zone">
                    ...
                    <div className="col-sm-4 d-none d-sm-block">
                      <div className="mx-md-4">
                        <img
                          src="/frontend/user/images/icons/id-back.svg"
                          alt="ID Back"
                        />
                      </div>
                    </div>
              ...
              <div className="nk-kycfm-head">
                ...
                <div className="nk-kycfm-title">
                  ...
                  <p className="sub-title">
                    To verify your address, please upload any of your document.
                  </p>
                </div>
              </div>
              {/* .nk-kycfm-head */}
                ...
                <ul className="nk-kycfm-control-list g-3">
                  <li className="nk-kycfm-control-item">
                    <input
                      ...
                      defaultChecked=""
                    />
                    <label className="nk-kycfm-label" htmlFor="bank-statement">
                      <span className="nk-kycfm-label-icon">
                        <span className="label-icon">
                          <svg
                            version={1.0}
                  ...
                  <li className="nk-kycfm-control-item">
                    ...
                    />
                    <label className="nk-kycfm-label" htmlFor="other-documents">
                      <span className="nk-kycfm-label-icon">
                        <span className="label-icon">
                          <svg
                            viewBox="0 0 24 24"
                ...
                <div className="nk-kycfm-upload">
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-sm-4 d-none d-sm-block">
                      <div className="mx-md-4">
                        <img
                          src="/frontend/user/images/icons/secure-documents-icon.svg"
                          alt="ID Front"
                        />
                      </div>
                    </div>
